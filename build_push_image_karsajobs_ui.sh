#!/bin/sh
# Perintah untuk membuat Docker image dari Dockerfile yang tadi dibuat, dengan nama image karsajobs-ui:latest.
docker build -t ghcr.io/farrel216/karsajobs-ui:latest .
...
docker push ghcr.io/farrel216/karsajobs-ui:latest